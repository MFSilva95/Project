...
public class ImportExport extends Activity {
	...
	public void createPDF(View v) throws Exception {
		...
		File dir = new File(Environment.getExternalStorageDirectory() + "/MyDiabetes/Export");
		dir.mkdirs();
		...
		if(cb.isChecked()){
			...
			String sub = "Relatório diabetes - " + datefrom.getText().toString() + " a " + dateto.getText().toString() + ".";
	...
	private void addTitlePage(Document document) throws DocumentException {
		    ...
		    EditText datefrom = (EditText)findViewById(R.id.et_pdfexport_DataFrom);
		    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		    title.add(new Paragraph("De " + datefrom.getText().toString() +  " a " + dateto.getText().toString()));
		    addEmptyLine(title, 1);
		    document.add(title);
	}
	
	private void addUserInfo(Document document) throws DocumentException, IOException {
	    ...
	    header.add(new Paragraph("Rácio Insulina: " + obj[3].toString(), headerFont));
	    header.add(new Paragraph("Rácio H. Carbono: " + obj[4].toString(), headerFont));
	...
	private void addGlycemia(Document document) throws DocumentException, IOException {
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<GlycemiaDataBinding> reads = rdb.Glycemia_GetByDate(datefrom.getText().toString(), dateto.getText().toString());
		...
		for(GlycemiaDataBinding g : reads){
			...
			t.addCell(new Phrase((g.getIdNote()>0) ? rdb.Note_GetById(g.getIdNote()).getNote() : "", cf));
		}
	...
	private void addInsulin(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<InsulinRegDataBinding> reads = rdb.InsulinReg_GetByDate(datefrom.getText().toString(), dateto.getText().toString());
		...
		for(InsulinRegDataBinding i : reads){
			...
			t.addCell(new Phrase(String.valueOf((i.getIdBloodGlucose()>0) ? rdb.Glycemia_GetById(i.getIdBloodGlucose()).getValue() : ""), cf));
			t.addCell(new Phrase(String.valueOf(i.getTargetGlycemia()), cf));
			t.addCell(new Phrase(rdb.Insulin_GetById(i.getIdInsulin()).getName(), cf));
			t.addCell(new Phrase(String.valueOf(i.getInsulinUnits()), cf));
			t.addCell(new Phrase(rdb.Tag_GetById(i.getIdTag()).getName(), cf));
			t.addCell((i.getIdNote()>0) ? new Phrase(rdb.Note_GetById(i.getIdNote()).getNote(), cf) : new Phrase("", cf));
		}
	...
	private void addExercise(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<ExerciseRegDataBinding> reads = rdb.ExerciseReg_GetByDate(datefrom.getText().toString(), dateto.getText().toString());
	...
	private void addCarbs(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<CarbsDataBinding> reads = rdb.CarboHydrate_GetBtDate(datefrom.getText().toString(), dateto.getText().toString());
		PdfPTable t = new PdfPTable(6);
		...
		for(CarbsDataBinding i : reads){
			...
			t.addCell((i.getId_Note()>0) ? new Phrase(rdb.Note_GetById(i.getId_Note()).getNote(), cf) : new Phrase("", cf));
		}
	...
	private void addBPressure(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<BloodPressureDataBinding> reads = rdb.BloodPressure_GetBtDate(datefrom.getText().toString(), dateto.getText().toString());
		PdfPTable t = new PdfPTable(6);
	...
	private void addDisease(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<DiseaseRegDataBinding> reads = rdb.DiseaseReg_GetByDate(datefrom.getText().toString(), dateto.getText().toString());
	...
	private void addCholesterol(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<CholesterolDataBinding> reads = rdb.Cholesterol_GetBtDate(datefrom.getText().toString(), dateto.getText().toString());
		PdfPTable t = new PdfPTable(4);
	...
	private void addWeight(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<WeightDataBinding> reads = rdb.Weight_GetBtDate(datefrom.getText().toString(), dateto.getText().toString());
		PdfPTable t = new PdfPTable(4);
	...
	private void addHbA1c(Document document) throws DocumentException, IOException {
		Font hFont = new Font(Font.HELVETICA, 14, Font.BOLD);
		Paragraph title = new Paragraph();
		addEmptyLine(title, 1);
		title.setFont(hFont);
	    ...
	    EditText dateto = (EditText)findViewById(R.id.et_pdfexport_DataTo);
		DB_Read rdb = new DB_Read(this);
		ArrayList<HbA1cDataBinding> reads = rdb.HbA1c_GetBtDate(datefrom.getText().toString(), dateto.getText().toString());
		PdfPTable t = new PdfPTable(4);
	...
	public void backup(View v){
		if(isSDWriteable()){
			File inputFile = new File(Environment.getDataDirectory() + "/data/" + this.getPackageName() + "/databases/DB_Diabetes");
			
			File outputDir = new File(Environment.getExternalStorageDirectory() + "/MyDiabetes/backup");
			outputDir.mkdirs();
			if (inputFile.exists()) {
	...
	public void restore(View v){
		if(isSDWriteable()){
			...
			File outputDir = new File(Environment.getDataDirectory() + "/data/" + this.getPackageName() + "/databases");
			outputDir.mkdirs();
			if (inputFile.exists()) {
		        File fileBackup = new File(outputDir, "DB_Diabetes");
		        try {
