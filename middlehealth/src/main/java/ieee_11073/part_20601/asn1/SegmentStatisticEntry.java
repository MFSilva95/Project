...
import org.bn.types.*;
    ...
    public class SegmentStatisticEntry implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "segm-stat-type", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )

	private SegmStatType segm_stat_type = null;

  @ASN1OctetString( name = "" )

        @ASN1Element ( name = "segm-stat-entry", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 1  )
