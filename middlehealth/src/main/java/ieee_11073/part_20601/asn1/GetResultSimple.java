...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "GetResultSimple", isSet = false )
	...
	private HANDLE obj_handle = null;
        ...
        @ASN1Element ( name = "attribute-list", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 1  )
	...
	private AttributeList attribute_list = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(GetResultSimple.class);
