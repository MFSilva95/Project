...
import com.jadg.mydiabetes.middleHealth.org.bn.coders.Encoder;
...
public class PERAlignedEncoder<T> extends Encoder<T> {
    ...
    public int encodeObjectIdentifier(Object object, OutputStream stream,
        ...
        byte[] buffer = com.jadg.mydiabetes.middleHealth.org.bn.coders.ber.BERObjectIdentifier.Encode(ia);
