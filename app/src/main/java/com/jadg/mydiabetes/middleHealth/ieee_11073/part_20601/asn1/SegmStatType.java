...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "SegmStatType" )
    public class SegmStatType implements IASN1PreparedElement {

            @ASN1Integer( name = "SegmStatType" )
		...
		max = 65535L
            ...
            public SegmStatType(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SegmStatType.class);
