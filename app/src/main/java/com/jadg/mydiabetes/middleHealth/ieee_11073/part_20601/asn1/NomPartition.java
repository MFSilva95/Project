...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "NomPartition" )
    public class NomPartition implements IASN1PreparedElement {

            @ASN1Integer( name = "NomPartition" )
		...
		max = 65535L
            ...
            public NomPartition(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(NomPartition.class);
