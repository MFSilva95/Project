...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "HANDLE" )
    public class HANDLE implements IASN1PreparedElement {


        @ASN1Element ( name = "HANDLE", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(HANDLE.class);
