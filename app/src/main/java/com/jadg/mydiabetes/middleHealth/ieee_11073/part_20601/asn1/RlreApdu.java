...
@ASN1PreparedElement
    @ASN1Sequence ( name = "RlreApdu", isSet = false )
    public class RlreApdu implements IASN1PreparedElement {

        @ASN1Element ( name = "reason", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )
	...
	private ReleaseResponseReason reason = null;
        ...
        public void setReason (ReleaseResponseReason value) {
            this.reason = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RlreApdu.class);
