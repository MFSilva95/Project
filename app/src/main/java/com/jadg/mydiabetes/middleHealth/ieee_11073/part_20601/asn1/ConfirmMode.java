...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "ConfirmMode" )
    public class ConfirmMode implements IASN1PreparedElement {

            @ASN1Integer( name = "ConfirmMode" )
		...
		max = 65535L
            ...
            public ConfirmMode(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ConfirmMode.class);
