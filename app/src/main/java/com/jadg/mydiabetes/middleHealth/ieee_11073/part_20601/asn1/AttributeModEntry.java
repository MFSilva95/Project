...
@ASN1PreparedElement
    ...
    public class AttributeModEntry implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "modify-operator", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )

	private ModifyOperator modify_operator = null;


        @ASN1Element ( name = "attribute", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 1  )
