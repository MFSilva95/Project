...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "ReleaseRequestReason" )
    public class ReleaseRequestReason implements IASN1PreparedElement {

            @ASN1Integer( name = "ReleaseRequestReason" )
		...
		max = 65535L
            ...
            public ReleaseRequestReason(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ReleaseRequestReason.class);
