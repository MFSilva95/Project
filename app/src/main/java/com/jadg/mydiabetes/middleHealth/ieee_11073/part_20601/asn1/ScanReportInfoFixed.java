...
@ASN1SequenceOf( name = "", isSetOf = false )
        ...
        @ASN1Element ( name = "obs-scan-fixed", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 2  )
	...
	private java.util.Collection<ObservationScanFixed>  obs_scan_fixed = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ScanReportInfoFixed.class);
