...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "FLOAT_Type" )
    public class FLOAT_Type implements IASN1PreparedElement {


        @ASN1Element ( name = "FLOAT-Type", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(FLOAT_Type.class);
