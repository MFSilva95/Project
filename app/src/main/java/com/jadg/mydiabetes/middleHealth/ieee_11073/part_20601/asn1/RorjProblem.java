...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "RorjProblem" )
    public class RorjProblem implements IASN1PreparedElement {

            @ASN1Integer( name = "RorjProblem" )
		...
		max = 65535L
            ...
            public RorjProblem(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RorjProblem.class);
