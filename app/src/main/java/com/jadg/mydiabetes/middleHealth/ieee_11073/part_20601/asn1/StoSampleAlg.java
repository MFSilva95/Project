...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "StoSampleAlg" )
    public class StoSampleAlg implements IASN1PreparedElement {

            @ASN1Integer( name = "StoSampleAlg" )
		...
		max = 65535L
            ...
            public StoSampleAlg(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(StoSampleAlg.class);
