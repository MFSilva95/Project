...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "ConfigId" )
    public class ConfigId implements IASN1PreparedElement {

            @ASN1Integer( name = "ConfigId" )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ConfigId.class);
