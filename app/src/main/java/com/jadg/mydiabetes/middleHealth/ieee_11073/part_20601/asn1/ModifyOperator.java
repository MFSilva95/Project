...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "ModifyOperator" )
    public class ModifyOperator implements IASN1PreparedElement {

            @ASN1Integer( name = "ModifyOperator" )
		...
		max = 65535L
            ...
            public ModifyOperator(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ModifyOperator.class);
