...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "PersonId" )
    public class PersonId implements IASN1PreparedElement {

            @ASN1Integer( name = "PersonId" )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PersonId.class);
