...
public class AndroidStreamManager extends StreamManager {
	...
	private static final String TAG = AndroidStreamManager.class.getCanonicalName();
	...
	public InputStream getInputStream(String strFilePath, String strBasePath,
		...
		Log.d(TAG, "getInputStream() called with: " + "strFilePath = [" + strFilePath + "], strBasePath = [" + strBasePath + "], strFileName = [" + strFileName + "], strCurDir = [" + strCurDir + "]");
