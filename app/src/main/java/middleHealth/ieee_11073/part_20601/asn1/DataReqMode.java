...
import middleHealth.org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "DataReqMode" )
    public class DataReqMode implements IASN1PreparedElement {

            @ASN1BitString( name = "DataReqMode" )
            ...
            public DataReqMode(BitString value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(DataReqMode.class);
