...
@ASN1PreparedElement
    ...
    public class ConfigObject implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "obj-class", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )

	private OID_Type obj_class = null;


        @ASN1Element ( name = "obj-handle", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 1  )

	private HANDLE obj_handle = null;


        @ASN1Element ( name = "attributes", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 2  )
