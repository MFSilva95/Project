...
import middleHealth.org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "PowerStatus" )
    public class PowerStatus implements IASN1PreparedElement {

            @ASN1BitString( name = "PowerStatus" )
            ...
            public PowerStatus(BitString value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(PowerStatus.class);
