...
import middleHealth.org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "SaFlags" )
    public class SaFlags implements IASN1PreparedElement {

            @ASN1BitString( name = "SaFlags" )
            ...
            public SaFlags(BitString value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SaFlags.class);
