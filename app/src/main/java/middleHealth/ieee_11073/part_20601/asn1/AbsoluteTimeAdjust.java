...
import middleHealth.org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "AbsoluteTimeAdjust" )
    public class AbsoluteTimeAdjust implements IASN1PreparedElement {

            @ASN1OctetString( name = "AbsoluteTimeAdjust" )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AbsoluteTimeAdjust.class);
