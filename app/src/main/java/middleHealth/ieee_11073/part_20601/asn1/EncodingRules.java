...
import middleHealth.org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1BoxedType ( name = "EncodingRules" )
    public class EncodingRules implements IASN1PreparedElement {

            @ASN1BitString( name = "EncodingRules" )
            ...
            public EncodingRules(BitString value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(EncodingRules.class);
