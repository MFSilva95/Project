...
package middleHealth.org.bn.coders.per;
...
import middleHealth.org.bn.metadata.constraints.ASN1SizeConstraintMetadata;
...
import middleHealth.org.bn.types.*;
import middleHealth.org.bn.utils.*;
...
public class PERAlignedEncoder<T> extends Encoder<T> {
    ...
    public int encodeObjectIdentifier(Object object, OutputStream stream,
        ...
        byte[] buffer = middleHealth.org.bn.coders.ber.BERObjectIdentifier.Encode(ia);
