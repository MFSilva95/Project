...
import pt.it.porto.mydiabetes.middleHealth.es.libresoft.openhealth.DeviceConfigCreator;
...
import pt.it.porto.mydiabetes.middleHealth.ieee_11073.part_104zz.manager.DS_Extended;
import pt.it.porto.mydiabetes.middleHealth.ieee_11073.part_104zz.manager.DeviceSpecializationFactory;
import pt.it.porto.mydiabetes.middleHealth.ieee_11073.part_20601.asn1.AarqApdu;
...
import pt.it.porto.mydiabetes.middleHealth.ieee_11073.part_20601.asn1.DataProtoList;
...
import pt.it.porto.mydiabetes.middleHealth.ieee_11073.part_20601.fsm.Unassociated;
...
public final class MUnassociated extends Unassociated {
	...
	private DeviceConfig getDeviceConfiguration (PhdAssociationInformation phd, int data_proto_id) {
		...
		int bytes = 0x000000FF & phd.getEncoding_rules().getValue().getValue()[0];
		bytes = (bytes << 8) | phd.getEncoding_rules().getValue().getValue()[1];
		String srules = Device11073.MDER_DEFUALT;
