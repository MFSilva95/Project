...
import pt.it.porto.mydiabetes.middleHealth.org.bn.coders.Encoder;
...
import pt.it.porto.mydiabetes.middleHealth.org.bn.utils.BitArrayOutputStream;
...
public class PERAlignedEncoder<T> extends Encoder<T> {
    ...
    public int encodeObjectIdentifier(Object object, OutputStream stream,
        ...
        byte[] buffer = pt.it.porto.mydiabetes.middleHealth.org.bn.coders.ber.BERObjectIdentifier.Encode(ia);
