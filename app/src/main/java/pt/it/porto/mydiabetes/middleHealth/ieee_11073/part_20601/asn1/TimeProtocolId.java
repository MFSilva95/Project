...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "TimeProtocolId" )
    public class TimeProtocolId implements IASN1PreparedElement {


        @ASN1Element ( name = "TimeProtocolId", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )

        private OID_Type  value;



        public TimeProtocolId () {
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(TimeProtocolId.class);
