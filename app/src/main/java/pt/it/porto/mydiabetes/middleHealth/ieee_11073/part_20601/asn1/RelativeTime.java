...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "RelativeTime" )
    public class RelativeTime implements IASN1PreparedElement {


        @ASN1Element ( name = "RelativeTime", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RelativeTime.class);
