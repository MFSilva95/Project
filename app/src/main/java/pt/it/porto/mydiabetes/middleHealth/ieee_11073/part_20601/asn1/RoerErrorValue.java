...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "RoerErrorValue" )
    public class RoerErrorValue implements IASN1PreparedElement {

            @ASN1Integer( name = "RoerErrorValue" )
		...
		max = 65535L
            ...
            public RoerErrorValue() {
            }

            public RoerErrorValue(Integer value) {
                this.value = value;
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(RoerErrorValue.class);
