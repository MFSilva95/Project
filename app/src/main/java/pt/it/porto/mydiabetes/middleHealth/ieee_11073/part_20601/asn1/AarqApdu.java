...
@ASN1PreparedElement
    ...
    public class AarqApdu implements IASN1PreparedElement {
        ...
        @ASN1Element ( name = "assoc-version", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )

	private AssociationVersion assoc_version = null;


        @ASN1Element ( name = "data-proto-list", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 1  )
