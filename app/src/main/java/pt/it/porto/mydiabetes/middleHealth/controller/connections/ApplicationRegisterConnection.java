...
import pt.it.porto.mydiabetes.middleHealth.controller.EventCallback;
import pt.it.porto.mydiabetes.middleHealth.es.libresoft.openhealth.android.IApplicationRegister;
import pt.it.porto.mydiabetes.middleHealth.es.libresoft.openhealth.android.IEventCallback;
import pt.it.porto.mydiabetes.middleHealth.es.libresoft.openhealth.android.serviceInterfaces.ApplicationRegisterService;
...
public class ApplicationRegisterConnection extends AbstractConnection
{
	...
	{
		return super.initialize(context, pt.it.porto.mydiabetes.middleHealth.es.libresoft.openhealth.android.MiddleHealth.class, ApplicationRegisterService.TAG);
	}
