...
*/
package pt.it.porto.mydiabetes.middleHealth.org.bn.coders.mder;

import pt.it.porto.mydiabetes.middleHealth.org.bn.annotations.ASN1Element;
import pt.it.porto.mydiabetes.middleHealth.org.bn.annotations.ASN1Float;
import pt.it.porto.mydiabetes.middleHealth.org.bn.annotations.ASN1SFloat;
...
import pt.it.porto.mydiabetes.middleHealth.org.bn.coders.UniversalTag;
...
public class MDERCoderUtils {
    ...
    public static boolean valueInRange (RestrictedInteger intType, long value) throws Exception{
    	if (intType== RestrictedInteger.INT_U8)
    		return (0L<=value && value<=255L);
    	else if (intType== RestrictedInteger.INT_I8)
    		return (-128L<=value && value<=127L);
    	else if (intType== RestrictedInteger.INT_U16)
    		return (0L<=value && value<=65535L);
    	else if (intType== RestrictedInteger.INT_I16)
    		return (-32768L<=value && value<=32767L);
    	else if (intType== RestrictedInteger.INT_U32)
    		return (0L<=value && value<=4294967295L);
    	else if (intType== RestrictedInteger.INT_I32)
    ...
    public static int getIntegerSubtypeLength (RestrictedInteger intType) throws Exception{
    	if ((intType== RestrictedInteger.INT_U8)||(intType== RestrictedInteger.INT_I8))
        	return 1;
        else if ((intType== RestrictedInteger.INT_U16)||(intType== RestrictedInteger.INT_I16))
        	return 2;
        else if ((intType== RestrictedInteger.INT_U32)||(intType== RestrictedInteger.INT_I32))
        	return 4;
