...
@ASN1PreparedElement
    @ASN1BoxedType ( name = "ConfigObjectList" )
    public class ConfigObjectList implements IASN1PreparedElement {


            @ASN1SequenceOf( name = "ConfigObjectList" , isSetOf = false)
	    private java.util.Collection<ConfigObject> value = null;

            public ConfigObjectList () {
            }

            public ConfigObjectList ( java.util.Collection<ConfigObject> value ) {
                setValue(value);
            }

            public void setValue(java.util.Collection<ConfigObject> value) {
                this.value = value;
            }

            public java.util.Collection<ConfigObject> getValue() {
                return this.value;
            }

            public void initValue() {
                setValue(new java.util.LinkedList<ConfigObject>());
            }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(ConfigObjectList.class);
