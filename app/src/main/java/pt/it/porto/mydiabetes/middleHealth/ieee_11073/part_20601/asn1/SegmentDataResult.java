...
@ASN1PreparedElement
    @ASN1Sequence ( name = "SegmentDataResult", isSet = false )
    public class SegmentDataResult implements IASN1PreparedElement {

        @ASN1Element ( name = "segm-data-event-descr", isOptional =  false , hasTag =  false  , hasDefaultValue =  false, hasExplicitOrder = true, declarationOrder = 0  )
	...
	private SegmDataEventDescr segm_data_event_descr = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(SegmentDataResult.class);
