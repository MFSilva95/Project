...
public class DB_Handler_old extends SQLiteOpenHelper {
    ...
    public DB_Handler_old(Context context) {
//        super(context, DATABASE_VERSION <= DATABASE_VERSION_V2 ? DATABASE_NAME_V2 : DATABASE_NAME, null, DATABASE_VERSION);
    ...
    public void insertIntoDB(File inputFile) throws Exception{
        ...
        DB_Handler_old dbwrite = new DB_Handler_old(this.myContext);
...
//
//		}
//		if (oldVersion < DB_Handler_old.DATABASE_VERSION) {
//			initDatabaseTables(db); // creates new feature table and Db_Info and Badges and points
//			if (oldVersion == DB_Handler_old.DATABASE_VERSION_USERID_BADGES) { //need to update BADGES
