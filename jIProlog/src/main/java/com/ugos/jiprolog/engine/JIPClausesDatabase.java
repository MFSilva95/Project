...
public abstract class JIPClausesDatabase extends Object
{
   ...
   public final int getIndex()
   {
    ...
    public abstract void setAttributes(String tableName, String url, Connection connection);
    ...
    public final void setFunctor(final String strFuncName, final int nArity)
    {
...
//      m_strModuleName = strModuleName;
    ...
    public final void setJIPEngine(final JIPEngine jip)
    {
        m_jip = jip;
    }
