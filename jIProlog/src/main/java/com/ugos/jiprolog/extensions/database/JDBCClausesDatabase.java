...
public class JDBCClausesDatabase extends JIPClausesDatabase
{
    ...
    public final void setAttributes(String tableName, String url, Connection connection)
    {
...
//          System.out.println(strSQL);
    ...
    public ResultSet _getResultSet_(int limit) throws SQLException
    {
        if(m_rs == null)
        {
            Statement stmt = getConnection().createStatement();
            ...
            if(stmt.execute(query))
            {
                ...
                setArity(m_rsmd.getColumnCount());
                fillClauseDB();
            }
            else
            {
    ...
    public void fillClauseDB() throws SQLException {
        //System.out.println("FILL CLAUSE_BEGIN");
        if(m_rs == null)
            return;
        ...
        while(m_rs.next())
        {
            JIPClause clause = getCurClause();
            //System.out.println("NEW_CLAUSE:"+clause.getValue());
            clauseList.add(clause);
        }
        //System.out.println("FILL CLAUSE_END");
    }
